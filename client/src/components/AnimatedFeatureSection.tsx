...
const shortcuts: ShortcutFeature[] = [
  ...
  {
    shortcut: "Alt + Shift + G/T/L",
    description: "Generate Daftar Gambar/Tabel",
  },
  {
    shortcut: "Ctrl + Alt + G/T/L",
    description: "Caption 2 Digit dengan nomor BAB (4.1)",
    isAdvanced: true,
  },
  {
    shortcut: "Alt + K",
    description: "Halaman Latin (a, b, c)",
    isAdvanced: true,
  },
  {
    shortcut: "Alt + R",
    description: "Halaman Romawi (i, ii, iii)",
    isAdvanced: true,
  },
  {
    shortcut: "Alt + Shift + K",
    description: "Nomor Halaman Otomatis dengan deteksi posisi BAB",
    isAdvanced: true,
  },
  {
    shortcut: "Ctrl + Alt + K",
    description: "Atur Posisi Nomor Halaman (tengah/kanan atas)",
    isAdvanced: true,
  },
  {
    shortcut: "Alt + C",
    description: "Hapus Nomor Halaman pada halaman tertentu",
    isAdvanced: true,
  },
  {
    shortcut: "Alt + Q",
    description: "Format Painter: Copy format teks/paragraf",
    isAdvanced: true,
    highlight: true,
  },
  {
    shortcut: "Alt + W",
    description: "Format Painter: Paste format ke teks/paragraf lain",
    isAdvanced: true,
    highlight: true,
  },
];

const FeatureCard: React.FC<{ feature: ShortcutFeature; index: number }> = ({
  feature,
  index,
}) => {
      ...
      <div className="flex flex-col">
        ...
        {feature.isAdvanced && (
          <div className="mt-2 flex items-center self-start">
            ...
            <span className="text-sm bg-blue-50 px-2 py-0.5 rounded-md text-blue-700 font-medium border border-blue-200">
              Advanced
            </span>
          </div>
        )}
  ...
  return (
    <div className="px-4">
      <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100 mb-8">
        ...
        >
          ...
          <p className="text-gray-600 max-w-3xl text-lg leading-relaxed">
            Gunakan pintasan keyboard intuitive untuk mempercepat format skripsi
            Anda
          </p>
        </motion.div>
      </div>
      ...
      <div className="mb-16 relative">
        ...
        >
          <div className="flex flex-col items-center text-center mb-10">
            <div className="inline-flex items-center justify-center px-4 py-1 mb-3 bg-blue-100 text-blue-700 text-xs font-medium uppercase tracking-wider rounded-full">
              Paket Dasar
            </div>
            ...
            <p className="text-gray-600 max-w-2xl">
              Fitur-fitur esensial untuk memulai format dokumen skripsi Anda
        ...
        <div className="flex justify-center mt-6 relative z-10">
          <div className="text-gray-700 text-sm italic font-medium bg-white px-5 py-2.5 rounded-lg border border-gray-200 shadow-sm">
            <span className="text-blue-600 font-semibold">*</span> Fitur dasar
            untuk pemformatan skripsi dengan harga Rp 50.000
          </div>
        </div>
      </div>
      ...
      <div className="mb-20 relative">
        ...
        >
          <div className="flex flex-col items-center text-center mb-10">
            <div className="inline-flex items-center justify-center px-4 py-1 mb-3 bg-blue-500 text-white text-xs font-medium uppercase tracking-wider rounded-full">
              Paket Premium
            </div>
            <h3 className="text-2xl md:text-3xl font-bold text-black mb-2">
              Advanced Package
            ...
            <p className="text-gray-600 max-w-2xl">
              Fitur-fitur profesional untuk otomatisasi lengkap dengan penomoran
              2-digit dan format painter
            </p>
          </div>
        </motion.div>
        ...
        <div className="flex justify-center mt-6 relative z-10">
          <div className="text-blue-800 text-sm italic font-medium bg-blue-50 px-5 py-2.5 rounded-lg border border-blue-200 shadow-sm">
            <span className="text-blue-600 font-semibold">*</span> Fitur
            profesional dengan penomoran 2-digit dan format painter dengan harga
            Rp 100.000
          </div>
        </div>
      ...
      <div className="mb-20 relative">
        <div className="overflow-hidden w-full">
          <h3 className="text-xl sm:text-2xl font-bold mb-6 text-center text-gray-900">
            Perbandingan Fitur Basic vs Advance
          </h3>
          <div className="overflow-x-auto p-4 rounded-lg bg-white shadow-lg border border-gray-100">
            <table className="w-full border-collapse bg-white rounded-lg">
              <thead>
                <tr className="bg-blue-50">
                  <th className="p-3 text-center text-gray-700 border-b">
                    Fitur
                  </th>
                  <th className="p-3 text-center text-gray-700 border-b">
                    Basic
                  </th>
                  <th className="p-3 text-center text-blue-800 border-b bg-blue-100/50">
                    Advance
                  </th>
                </tr>
              </thead>
              <tbody>
                <tr className="hover:bg-gray-50">
                  <td className="p-3 pl-6 border-b text-gray-700 text-left">
                    Format heading otomatis (Alt+1, Alt+2)
                  </td>
                ...
                <tr className="hover:bg-gray-50">
                  <td className="p-3 pl-6 border-b text-gray-700 text-left">
                    <div className="font-medium">
                      Membuat caption (Alt+G/T/L)
                    </div>
                    <div className="text-xs text-gray-500 mt-1">
                      Alt+G untuk gambar, Alt+T untuk tabel, Alt+L untuk
                      lampiran
                    </div>
                  </td>
                  <td className="p-3 border-b text-center">
                ...
                <tr className="hover:bg-gray-50">
                  <td className="p-3 pl-6 border-b text-gray-700 text-left">
                    <div className="font-medium">
                      Caption dengan nomor BAB (Gambar 4.1)
                    </div>
                    <div className="text-xs text-gray-500 mt-1">
                      Penomoran otomatis sesuai dengan BAB (cth: "Gambar 4.1")
                    </div>
                  </td>
                  <td className="p-3 border-b text-center">
                ...
                <tr className="hover:bg-gray-50">
                  <td className="p-3 pl-6 border-b text-gray-700 text-left">
                    <div className="font-medium">
                      Daftar isi gambar/tabel/lampiran (Alt+Shift+G/T/L)
                    </div>
                    <div className="text-xs text-gray-500 mt-1">
                      Tampilkan tabel daftar isi dari caption yang telah dibuat
                    </div>
                  </td>
                  <td className="p-3 border-b text-center">
                    <X className="h-5 w-5 text-gray-400 mx-auto" />
                ...
                <tr className="hover:bg-gray-50">
                  <td className="p-3 pl-6 border-b text-gray-700 text-left">
                    <div className="font-medium">
                      Penomoran halaman campuran (Alt+K, Alt+R)
                    </div>
                    <div className="text-xs text-gray-500 mt-1">
                      Angka Arab (Alt+K) dan Romawi (Alt+R) untuk berbagai
                      bagian
                    </div>
                  </td>
                  <td className="p-3 border-b text-center">
                ...
                <tr className="hover:bg-gray-50">
                  <td className="p-3 pl-6 border-b text-gray-700 text-left">
                    <div className="font-medium">
                      Penomoran halaman otomatis (Alt+Shift+K)
                    </div>
                    <div className="text-xs text-gray-500 mt-1">
                      Deteksi posisi bab dan format halaman secara otomatis
                    </div>
                  </td>
                  <td className="p-3 border-b text-center">
                    <X className="h-5 w-5 text-gray-400 mx-auto" />
                ...
                <tr className="hover:bg-gray-50">
                  <td className="p-3 pl-6 border-b text-gray-700 text-left">
                    ...
                    <div className="text-xs text-gray-500 mt-1">
                      Opsi tengah bawah dan kanan atas
                    </div>
                  </td>
                  <td className="p-3 border-b text-center">
                    <X className="h-5 w-5 text-gray-400 mx-auto" />
                ...
                <tr className="hover:bg-gray-50">
                  <td className="p-3 pl-6 border-b text-gray-700 text-left">
                    <div className="font-medium">
                      Format painter (Alt+Q/W) & Hapus nomor (Alt+C)
                    </div>
                    <div className="text-xs text-gray-500 mt-1">
                      Copy format (Alt+Q), paste format (Alt+W), hapus nomor
                      halaman (Alt+C)
                    </div>
                  </td>
                  <td className="p-3 border-b text-center">
                ...
                <tr className="hover:bg-gray-50">
                  <td className="p-3 pl-6 border-b text-gray-700 font-medium text-left">
                    Dialog klik-pilih-selesai
                  </td>
                  <td className="p-3 border-b text-center">
                    <X className="h-5 w-5 text-gray-400 mx-auto" />
                  </td>
                ...
                <tr className="bg-gray-50">
                  <td className="p-3 pl-6 font-semibold text-gray-800 text-left">
                    Harga
                  </td>
                  <td className="p-3 text-center font-medium">Rp 50.000</td>
                  <td className="p-3 text-center font-medium bg-blue-100/50 text-blue-800">
                    Rp 100.000
                  </td>
                </tr>
              </tbody>
          ...
          <div className="rounded-2xl p-10 max-w-3xl mx-auto text-center shadow-lg border border-blue-200 relative overflow-hidden bg-gradient-to-r from-blue-50 to-white">
            <div className="relative z-10">
              <h2 className="text-3xl font-semibold mb-3 text-gray-900">
                Siap Menghemat Waktu Format Skripsi?
              </h2>
              <p className="text-lg text-gray-600 mb-8 max-w-xl mx-auto">
                Dapatkan Easy.kripsi sekarang dan fokus pada isi skripsi Anda,
                bukan formatnya.
              </p>
